...
#
# Run:  python -m fraud_platform.governance.run_demo
# The orchestrator is now reached by a plain package import — the
# sys.path bridge that used to wire the phases together is gone.
# =============================================================
