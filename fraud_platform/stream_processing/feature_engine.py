...
class FraudFeatureEngine:
    ...
    def _make_foreachbatch_sink(self):
        ...
        # NB: self._sf_writer (the row-by-row Snowflake fallback) is
        # deliberately NOT captured here — process_batch writes via the
        # S3->Snowpipe path (s3_writer). The fallback stays available on
