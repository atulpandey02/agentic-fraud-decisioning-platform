...
# Cross-phase bridge — same mechanics as governance/run_demo.py,
# one directory more: this runner drives the orchestrator (Phase 4)
# AND the governance layer (Phase 5). Our config is the superset
# of both, already cached under the name their modules import.
...
try:
    ...
    from policy_framework import GovernancePolicyFramework  # noqa: E402
    from hitl_handler import HITLHandler                # noqa: E402
finally:
    sys.path.remove(_MULTI_AGENT_DIR)
    sys.path.remove(_GOVERNANCE_DIR)
