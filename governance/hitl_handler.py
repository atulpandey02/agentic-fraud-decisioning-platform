...
# The schema contract + validators live in db/, shared across
# phases. Until Priority 3 makes this an installable package, they
# are reached the same way every other cross-directory import in
# this repo is — an explicit path insert. Priority 3 replaces this
# with a plain package import.
_DB_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "db"))
if _DB_DIR not in sys.path:
    sys.path.insert(0, _DB_DIR)
from validators import validate_decision_record, validate_review_outcome  # noqa: E402
